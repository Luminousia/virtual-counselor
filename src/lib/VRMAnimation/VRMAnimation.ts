...
export class VRMAnimation {
  ...
  public createAnimationClip(vrm: VRM, options?: { disableLookAt?: boolean }): THREE.AnimationClip {
    ...
    // 默认禁用 lookAt 轨道，让角色看向玩家而不是动画中的方向
    if (!options?.disableLookAt && vrm.lookAt != null) {
